...
class SerializableCipher {
    static cfg: { blockSize: number; iv: WordArray; format: typeof OpenSSL; };
    [x: string]: any;
    /**
     * Encrypts a message.
     *
...
class PasswordBasedCipher {
    static cfg: { blockSize: number; iv: WordArray; format: typeof OpenSSL; kdf: typeof OpenSSLKdf; };
    /**
...
class BlockCipherMode {
    static Encryptor: typeof BlockCipherModeAlgorithm;
    static Decryptor: typeof BlockCipherModeAlgorithm;
    /**
...
export { lib, algo, enc, pad, mode, AES$1 as AES, SHA256$1 as SHA256, MD5$1 as MD5, Hex, Latin1, Utf8, Base, BlockCipher, BufferedBlockAlgorithm, Cipher, CipherParams, Hasher, PasswordBasedCipher, SerializableCipher, WordArray, BlockCipherMode, CBC, ECB, NoPadding, PKCS7 };
